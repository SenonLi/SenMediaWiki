...
if($response){
	...
	echo '<p><a href="http://192.168.1.61/addNewProject.php" target="_blank">Add a New Project</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="http://192.168.1.61/getProjectRepos.php" >Disable Delete</a>
		</p><br/>';
	...
	while($row = mysqli_fetch_array($response))	{
	    ...
	    echo   '<tr>
			<td align = "left"><a href="http://192.168.1.61/editExistingProject.php?id=',urlencode($row["id"]),'" target="_blank" style="text-decoration:none">' . $row['projectName'] . '</a></td>
			<td align = "left"><a href="http://192.168.1.61/deleteProject.php?id=',urlencode($row["id"]),'" style="text-decoration:none, float:center">Delete</a></td>
		   </tr>';
	}
