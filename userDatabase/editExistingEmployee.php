...
<form action="http://10.122.38.71/submitEditedEmployee.php?id=<?php echo $id ?>" method="post">
	...
	<p> Employee ID:  <input type="text" name="employeeIDInput" size="30" value="<?php echo $employeeID ?> "/> </p>
	<p> First Name:  <input type="text" name="firstNameInput" size="30" value="<?php echo $firstName ?> "/> </p>
	<p> Nick Name (optional):  <input type="text" name="middleNameInput" size="30" value="<?php echo $middleName ?> "/> </p>
	<p> Last Name:  <input type="text" name="lastNameInput" size="30" value="<?php echo $lastName ?> "/> </p>
