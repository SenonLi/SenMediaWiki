...
if(isset($_POST['submitButton']))	{
	...
	if(empty($data_missing))	{
		...
		$insertQuery = "INSERT INTO huawei_projectRepo (projectName, path, description, cloneCommand) VALUES (?, ?, ?, ?)";



		$statement = mysqli_prepare($databaseConnection, $insertQuery);	
		mysqli_stmt_bind_param($statement, "ssss", $projectName, $path, $description, $cloneCommand );
