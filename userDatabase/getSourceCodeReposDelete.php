...
if($response){
	...
	echo '<p><a href="http://10.122.38.71/addNewSourceCode.php" target="_blank">New Source Code Repo</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="http://10.122.38.71/getSourceCodeRepos.php" >Disable Delete</a>
		</p><br/>';
	...
	while($row = mysqli_fetch_array($response))	{
	    ...
	    echo   '<tr>
			...
			<td align = "left"><a href="http://10.122.38.71/deleteSourceCode.php?id=',urlencode($row["id"]),'" style="text-decoration:none, float:center">Delete</a></td>
		   </tr>';
	}
