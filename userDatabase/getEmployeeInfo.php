...
if($response){
	...
	echo '<p><a href="http://10.122.38.71/addNewEmployee.php" target="_blank">Add a New Employee</a>
		&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="http://10.122.38.71/getEmployeeInfoDelete.php" >Enable Delete</a>
		</p><br/>';
	...
	while($row = mysqli_fetch_array($response))	{
	    ...
	    echo   '<tr>
			<td align = "left"><a href="http://10.122.38.71/displayExistingEmployee.php?id=',urlencode($row["id"]),'" target="_blank" style="text-decoration:none">' . $row['employeeID'] . '</a></td>
