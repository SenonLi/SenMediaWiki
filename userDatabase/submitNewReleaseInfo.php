...
if(isset($_POST['submitButton']))	{
	...
	if(empty($data_missing))	{
		...
		$insertQuery = "INSERT INTO huawei_releaseView (model, releaseName, sourceName, imageName, patch) VALUES (?, ?, ?, ?, ?)";



		$statement = mysqli_prepare($databaseConnection, $insertQuery);	
		mysqli_stmt_bind_param($statement, "sssss", $model, $releaseName, $sourceName, $imageName, $patch );
